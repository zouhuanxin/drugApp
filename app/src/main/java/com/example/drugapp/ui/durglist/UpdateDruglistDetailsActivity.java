...
public class UpdateDruglistDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatedruglistdetails);
        initView();
        initData();
    }
    ...
    private void initData(){
        ...
        Glide.with(UpdateDruglistDetailsActivity.this).load(url).into(addimage);
    }
        ...
        bmobFile.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    ToastUtil.toast(UpdateDruglistDetailsActivity.this, "上传文件失败：" + e.getMessage());
                }
            }
    ...
    private void updateDrug() throws JSONException {
        if (TextUtils.isEmpty(name.getText()) || TextUtils.isEmpty(desc.getText()) || TextUtils.isEmpty(createdtime.getText()) || url == null) {
            ToastUtil.toast(UpdateDruglistDetailsActivity.this, "错误");
            return;
        }
        ...
        HttpUtil.getInstance().POST(Apis.updateDruglist2, req.toString(), new HttpCallBack() {
            @Override
            ...
            public void Success(Call call, String res) throws Exception {
                ...
                ToastUtil.toast(UpdateDruglistDetailsActivity.this,rep.getString("msg"));
        ...
        Luban.with(this)
                ...
                .setCompressListener(new OnCompressListener() { //设置回调
                    ...
                    public void onSuccess(File file) {
                        Glide.with(UpdateDruglistDetailsActivity.this).load(file.getPath()).into(addimage);
