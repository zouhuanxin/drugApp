...
public class AddDrugActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        bmobFile.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    ToastUtil.toast(AddDrugActivity.this, "上传文件失败：" + e.getMessage());
                }
            }
    ...
    private void addDrug() throws JSONException {
        if (TextUtils.isEmpty(name.getText()) || TextUtils.isEmpty(desc.getText()) || TextUtils.isEmpty(createdtime.getText())
            ...
            ToastUtil.toast(AddDrugActivity.this, "错误");
            return;
        }
        ...
        HttpUtil.getInstance().POST(Apis.addDrugData, req.toString(), new HttpCallBack() {
            ...
            public void Success(Call call, String res) throws Exception {
                ...
                ToastUtil.toast(AddDrugActivity.this,rep.getString("msg"));
        ...
        Luban.with(this)
                ...
                .setCompressListener(new OnCompressListener() { //设置回调
                    ...
                    public void onSuccess(File file) {
                        ...
                        Glide.with(AddDrugActivity.this).load(file.getPath()).into(addimage);
