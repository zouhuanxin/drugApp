...
public class AddDrugActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adddrug2);
        initView();
        reqlist1();
    }
     ...
     * 添加用药信息
     */
    private void addDrug() throws JSONException {
        ...
        HttpUtil.getInstance().POST(Apis.addDrugData, req.toString(), new HttpCallBack() {
            @Override
            ...
            public void Success(Call call, String res) throws Exception {
                ...
                ToastUtil.toast(AddDrugActivity2.this, rep.getString("msg"));
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (druglist2s.size() == 0) {
                    ToastUtil.toast(AddDrugActivity2.this, "无数据");
                    return;
                }
                List<String> list = new ArrayList<String>();
